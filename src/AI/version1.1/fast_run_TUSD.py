...
seq_len = 420            # this is the amount of data (in minutes) used for the forecast
...
learning_rate = 0.0005   # (last best = 0.0001)
batch_size = 256        #
...
# This is the main run function
    ...
    # now we convert to TUSD:

    # df.iloc[::2, :] = df.iloc[::2, :] / df.loc["TUSD.p", :]
    ...
    joblib.dump(scaler, 'scaler_TUSD.save')
