...
epochs = 201 # input the epochs from command line (for model testing purposes only)
...
# This is the main run function
    ...
    # 126017
    pre_df = functions.data_load("dades_total.csv")
    ...
    if which_model == 1:
        ...
        model = lstm.build_model2_reg_inputed(dims, dropout, learning_rate)
    else:
